...
export const MODELS: ModelOption[] = [
    ...
    { id: "local-llm", label: "Local LLM", group: "Local" },
];

export const DEFAULT_MODEL_ID = "local-llm";

export const ALLOWED_MODEL_IDS = new Set(MODELS.map((m) => m.id));

const GROUP_ORDER: ModelOption["group"][] = ["Local", "Anthropic", "Google"];
