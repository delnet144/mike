...
const SCHEMA = `
-- local single-user schema for Mike (no auth, no row-level security)
...
insert or ignore into user_profiles (user_id, display_name, tier) values ('local-user', 'Local User', 'Free');
